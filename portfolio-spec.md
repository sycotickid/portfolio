...
- Placeholder shown until real headshot is supplied (`/static/headshot.jpg`)
...
- **Headshot**: 72×72px in About section, `border-radius: 8px`, blue-tinted dark border; source `/static/headshot.jpg`
