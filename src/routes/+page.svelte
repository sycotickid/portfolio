...
<main style="position: relative; z-index: 1;">
	...
	<img
		...
		alt=""
		aria-hidden="true"
		style="position: absolute; bottom: 0; left: 50%; width: 105vw; max-width: none; height: auto;
		       display: block; pointer-events: none; z-index: -1;
		       transform: translateX(calc(-50% + {imgSmoothX * -1}vw));"
	/>
</main>
...
{#if showScrollTop}
	<button
		...
		style="position: fixed; bottom: 32px; right: 32px; z-index: 40;
